                    ...
                    <tr>
                      ...
                      <tr>
                        <td align="center" valign="top" width="375" style="font-family: Open Sans, Helvetica, Arial, sans-serif; padding-top: 30px; borderTop: 1px solid #999, max-wdith: 375px; width: 375px; ">
                          ...
                          <p style="width: 375px; color: #132852; font-family: Georgia; font-size: 14px; margin: 0;">
                            ...
                            <table border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td align="center" style="border-radius: 28px;" bgcolor="#75b6c9">
                                        <a href="http://litmus.com" target="_blank" style="font-size: 18px; font-family: Open Sans, Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; border-radius: 28px; background-color: #75b6c9; padding: 16px 28px; border: 1px solid #75b6c9; display: block;">RSVP</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
